...
translate crowdin strings:
    ...
    # game/tool/notifications_value.rpy:13
    old "{color=#f00} {b}-{/b} Lust"
    new "{color=#f00} {b}-{/b} Lust"

    # game/tool/notifications_value.rpy:15
    old "{color=#00ff00}{b}+{/b} Friendship"
    new "{color=#00ff00}{b}+{/b} Friendship"

    # game/tool/notifications_value.rpy:16
    old "{color=#f00} {b}-{/b} Friendship"
    new "{color=#f00} {b}-{/b} Friendship"

    # game/tool/notifications_value.rpy:17
    old "{color=#00ff00}{b}+{/b} Favour"
    new "{color=#00ff00}{b}+{/b} Favour"

    # game/tool/notifications_value.rpy:18
    old "{color=#f00} {b}-{/b} Favour"
    new "{color=#f00} {b}-{/b} Favour"

    # game/tool/notifications_value.rpy:19
    old "{color=#00ff00}{b}+{/b} Love"
    new "{color=#00ff00}{b}+{/b} Love"

    # game/tool/notifications_value.rpy:20
    old "{color=#f00} {b}-{/b} Love"
    new "{color=#f00} {b}-{/b} Love"

    # game/tool/notifications_value.rpy:21
    old "{color=#00ff00}{b}+{/b} Corruption"
    new "{color=#00ff00}{b}+{/b} Corruption"

    # game/tool/notifications_value.rpy:22
    old "{color=#f00} {b}-{/b} Corruption"
    new "{color=#f00} {b}-{/b} Corruption"
    ...
    new "{color=#00ff00} {b}-{/b} Anger"

    # game/tool/notifications_value.rpy:25
    old "{color=#f00}{b}+{/b} Fear"
    new "{color=#f00}{b}+{/b} Fear"

    # game/tool/notifications_value.rpy:26
    old "{color=#00ff00} {b}-{/b} Fear"
    new "{color=#00ff00} {b}-{/b} Fear"
