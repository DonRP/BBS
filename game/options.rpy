...
define config.name = _("Bad Bobby Saga: The return")
...
define config.save_directory = "BadBobbySaga"
...
init python:
    ...
    build.archive('tools', 'all')
    build.classify('game/tool/**.rpyc', 'tools')

    build.archive('minigames', 'all')
    build.classify('game/minigame/**.rpyc', 'minigames')
